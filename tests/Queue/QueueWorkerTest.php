...
class QueueWorkerTest extends BackwardCompatibleTestCase
{
    ...
    public function testJobIsPoppedOffQueueAndProcessed()
    {
        $worker = $this->getMock(
            ...
            array('process'),
            array($manager = m::mock(\Illuminate\Queue\QueueManager::class))
        );
		...
		$job = m::mock(\Illuminate\Queue\Jobs\Job::class);
	...
	{
		$worker = new Illuminate\Queue\Worker(m::mock(\Illuminate\Queue\QueueManager::class), $failer = m::mock(
	...
	{
		$worker = new Illuminate\Queue\Worker(m::mock(\Illuminate\Queue\QueueManager::class));
		$job = m::mock(\Illuminate\Queue\Jobs\Job::class);
