...
class FoundationAssetPublisherTest extends BackwardCompatibleTestCase
{
    ...
    {
        $pub = new Illuminate\Foundation\AssetPublisher($files = m::mock(\Illuminate\Filesystem\Filesystem::class), __DIR__);
	...
	public function testPackageAssetPublishing()
	{
		...
		$pub = new Illuminate\Foundation\AssetPublisher($files2 = m::mock(\Illuminate\Filesystem\Filesystem::class), __DIR__);
